...
//  Today
//
//  Created by Berlin Thomas on 2023-08-28.
//
...
extension ReminderViewController {
    ...
    func dateConfiguration(for cell: UICollectionViewListCell, with date: Date) -> DatePickerContentView.Configuration {
        var contenConfiguration = cell.datePickerConfiguration()
        contenConfiguration.date = date
        contenConfiguration.onChange = { [weak self] dueDate in
