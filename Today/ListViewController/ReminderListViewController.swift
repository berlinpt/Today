...
//  Today
//
//  Created by Berlin Thomas on 2023-08-23.
//
...
class ReminderListViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        dataSources = DataSource(collectionView: collectionView) {
        ...
        dataSources.supplementaryViewProvider = { supplementaryView, elementKind, indexPath in
    ...
    private func makeSwipeActions(for indexPath: IndexPath?) -> UISwipeActionsConfiguration? {
        guard let indexPath = indexPath, let id = dataSources.itemIdentifier(for: indexPath) else {
            return nil
        }
    ...
    private func supplementaryRegistrationHandler(progressView: ProgressHeaderView, elementKid: String, indexPath: IndexPath) {
